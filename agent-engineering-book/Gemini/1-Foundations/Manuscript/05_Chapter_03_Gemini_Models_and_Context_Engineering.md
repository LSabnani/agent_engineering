...
*Designing the Information Environment for WidgetWare SDR*
...
## 3.1 Context is a designed operating environment

In Chapter 1 we defined the business boundary. In Chapter 2 we created the harness in which development occurs. Chapter 3 now answers a different question:
...
## 3.2 Model choice is an architectural decision
...
### Figure 3.1 — Model Selection as an Architectural Decision

<div class="figure-page landscape">
  <img src="figures/chapter3/model-selection-as-an-architectural-decision.png" alt="Figure 3.1 — Model Selection as an Architectural Decision" />
</div>
...
### Figure 3.2 — Layers of Context for WidgetWare SDR

<div class="figure-page landscape">
  <img src="figures/chapter3/layers-of-context-for-widgetware-sdr.png" alt="Figure 3.2 — Layers of Context for WidgetWare SDR" />
</div>
...
## 3.4 Stable policy should not be buried in prompts
...
This mirrors Chapter 1's ICP table exactly: the same industries (including logistics), the same three regions, the same exclusions (very small firms and purely consumer businesses become `excluded_industries`; unsupported regions become `excluded_regions`), and the same six trigger events from §1.10, not just a subset of them.
...
### Figure 3.3 — Policy as Data, Not Buried in Prompts

<div class="figure-page landscape">
  <img src="figures/chapter3/policy-as-data-not-buried-in-prompts.png" alt="Figure 3.3 — Policy as Data, Not Buried in Prompts" />
</div>
...
## 3.6 Context assembly is its own piece of software
...
### Figure 3.4 — Instruction Hierarchy and Context Assembly

<div class="figure-page landscape">
  <img src="figures/chapter3/instruction-hierarchy-and-context-assembly.png" alt="Figure 3.4 — Instruction Hierarchy and Context Assembly" />
</div>
...
## 3.8 Context quality failures and risk controls
...
### Figure 3.5 — Evidence Policy and Context Risk Controls

<div class="figure-page landscape">
  <img src="figures/chapter3/evidence-policy-and-context-risk-controls.png" alt="Figure 3.5 — Evidence Policy and Context Risk Controls" />
</div>

Reliable context is therefore not merely relevant. It is classified, traceable, and defended.

## 3.9 Suggested implementation artifacts
...
The project now has a deliberate model and context architecture. Gemini is no longer treated as a free-form chatbot sitting behind a prompt. Instead, it receives a structured, layered, and reviewable request package.

That matters because every later chapter depends on this discipline. Tools, workflows, structured outputs, and approval gates all become easier to engineer when the input boundary is already explicit.
...
1. Section 3.3 argues that stable policy should live in configuration rather than only in prompts. Pick one rule from your own domain that currently exists only as prose and rewrite it as configuration or a deterministic rule.
...
5. Suppose two engineers independently add account-size thresholds in different places: one in `icp.yaml`, another inside `instructions.py`. Explain why that duplication is dangerous and how Chapter 3’s architecture would eliminate it.
