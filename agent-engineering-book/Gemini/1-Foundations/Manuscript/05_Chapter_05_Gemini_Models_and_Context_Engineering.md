# Chapter 5: Gemini Models and Context Engineering
...
In Chapter 3 we defined the business boundary. In Chapter 4 we created the harness in which development occurs. Chapter 5 now answers a different question:
...
<div class="figure-page landscape">
  <img src="figures/chapter5/model-selection-as-an-architectural-decision.png" alt="Figure 5.1 — Model Selection as an Architectural Decision" />
</div>
...
<div class="figure-page landscape">
  <img src="figures/chapter5/layers-of-context-for-widgetware-sdr.png" alt="Figure 5.2 — Layers of Context for WidgetWare SDR" />
</div>
...
<div class="figure-page landscape">
  <img src="figures/chapter5/policy-as-data-not-buried-in-prompts.png" alt="Figure 5.3 — Policy as Data, Not Buried in Prompts" />
</div>
...
<div class="figure-page landscape">
  <img src="figures/chapter5/instruction-hierarchy-and-context-assembly.png" alt="Figure 5.4 — Instruction Hierarchy and Context Assembly" />
</div>
...
<div class="figure-page landscape">
  <img src="figures/chapter5/evidence-policy-and-context-risk-controls.png" alt="Figure 5.5 — Evidence Policy and Context Risk Controls" />
</div>
...
Chapter 6 introduces the core ADK abstractions and builds the first WidgetWare agent. The emphasis remains narrow: one agent, one responsibility, clear inputs, observable events, and no external tools yet.
...
5. Suppose two engineers independently add account-size thresholds in different places: one in `icp.yaml`, another inside `instructions.py`. Explain why that duplication is dangerous and how Chapter 5’s architecture would eliminate it.
