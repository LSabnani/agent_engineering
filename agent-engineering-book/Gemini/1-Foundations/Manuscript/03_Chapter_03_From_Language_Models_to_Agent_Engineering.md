...
Chapter 3 does not implement an agent. It defines the problem, the authority boundary, the expected artifacts, the target architecture, and the evidence that will later demonstrate success. Those decisions must exist before model prompts, tools, workflows, or deployment code.
...
<div class="figure-page landscape">
  <img src="figures/chapter3/the-seven-steps-to-agent-engineering.png" alt="Figure 3.1 — The Seven Steps to Agent Engineering" />
</div>
...
The numbered steps are not a rigid chapter order. Chapter 4 builds the development harness before Chapter 5 completes context because the reader needs a disciplined workspace in which to place the business rules. The framework describes engineering concerns and dependencies, not a mandatory waterfall.

Evaluation and governance appear as Step 7 because they provide the evidence required to release and improve the system. They are also cross-cutting disciplines. We define acceptance criteria in Chapter 3, write tests while building the harness, preserve evidence during research, enforce approval during orchestration, verify progress inside loops, and perform integrated evaluation before release.
...
<div class="figure-page landscape">
  <img src="figures/chapter3/end-to-end-b2b-sales-lifecycle.png" alt="Figure 3.2 — End-to-End B2B Sales Cycle" />
</div>
...
<div class="figure-page landscape">
  <img src="figures/chapter3/the-sdr-operating-process.png" alt="Figure 3.3 — The SDR Operating Process" />
</div>
...
<div class="figure-page landscape">
  <img src="figures/chapter3/widgetware-sdr-information-and-artifact-flow.png" alt="Figure 3.4 — WidgetWare SDR Information & Artifact Flow" />
</div>
...
## 3.12 Book 1 Google Cloud reference architecture

The following diagram shows the **Book 1 target architecture**, not the Chapter 3 implementation. Readers build it incrementally across the remaining chapters.

The design adapts Google Cloud guidance for ADK-based agent systems on Cloud Run, including standardized tool access through Model Context Protocol integrations and observability through Cloud Logging, Monitoring, and Trace.[^gcp-reference-architecture]

### Figure 3.5 — WidgetWare SDR Book 1 target architecture

<div class="figure-page landscape">
  <img src="figures/chapter3/widgetware-sdr-book-1-reference-architecture.png" alt="Figure 3.5 — WidgetWare SDR Book 1 Reference Architecture (Google Cloud)" />
</div>
...
- **A Cloud Run job** hosts the finite Chapter 13 batch process. Cloud Scheduler can invoke it using an authorized service account.[^scheduled-jobs]
...
The target architecture is now visible. Chapter 4 creates the environment in which it can be built safely, one bounded increment at a time.
