...
| [`common-mistakes.md`](common-mistakes.md) | 0:10–0:20 | Talking points on Class 3 homework's recurring issues |
...
- [ ] Print `context.assembled_prompt` from Class 3 on screen first, then ask what's missing to make it reason — sets up the whole class
