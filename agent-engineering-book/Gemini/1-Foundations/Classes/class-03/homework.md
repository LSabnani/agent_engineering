...
- No structured/typed output yet — the agent's result stays prose, on purpose. Class 5 replaces it with a contract.
- No Skill yet — the procedure lives directly in `qualification_agent.py`'s instruction string. Class 4 extracts it.
- No tools yet — Class 6.
