...
- No structured/typed output yet — the agent's result stays prose at this stage, on purpose. Class 6 replaces it with a contract.
- No tools yet. The agent still only reasons over what it's directly given. Class 7 adds tools.
