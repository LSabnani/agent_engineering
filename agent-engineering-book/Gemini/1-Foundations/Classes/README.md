...
An eleven-class, cumulative delivery of the Gemini edition's **Book 1** — two hours per class, one per Book 1 chapter, same instructional rhythm every class, one running WidgetWare SDR Lab codebase from Class 1 through the close of Book 1.
...
## The eleven classes (Book 1, one chapter each)

| Class | Manuscript source | Main capability | Golden solution |
| ----: | ------------------ | ---------------------------------------------------------- | --- |
| [1](classes/class-01/) | Book 1, Ch. 1 | Foundations, the WidgetWare specification (folds in course orientation) | ✅ verified (charter only, no code) |
| [2](classes/class-02/) | Book 1, Ch. 2 | Antigravity workspace and repository harness | ✅ verified — 3 passed |
| [3](classes/class-03/) | Book 1, Ch. 3 | Gemini context and instruction architecture | ✅ verified — 8 passed |
| [4](classes/class-04/) | Book 1, Ch. 4 | First ADK agent (embedded procedure, no Skills yet) | ✅ verified — 18 passed, 3 skipped |
| [5](classes/class-05/) | Book 1, Ch. 5 | Skills and reusable agent capabilities | ✅ verified — 17 passed, 3 skipped |
| [6](classes/class-06/) | Book 1, Ch. 6 | Structured outputs and agent contracts | ✅ verified — 29 passed, 3 skipped |
| [7](classes/class-07/) | Book 1, Ch. 7 | Tool engineering | ✅ verified — 44 passed, 3 skipped |
| [8](classes/class-08/) | Book 1, Ch. 8 | MCP and evidence-backed research | ✅ verified — 60 passed, 3 skipped |
| [9](classes/class-09/) | Book 1, Ch. 9 | Multi-agent workflow and human approval | ✅ verified — 90 passed, 3 skipped |
| [10](classes/class-10/) | Book 1, Ch. 10 | Evaluate, deploy, and demonstrate (no loop yet) | ✅ verified — 109 passed, 3 skipped |
| [11](classes/class-11/) | Book 1, Ch. 11 | Loop engineering with ADK — closes Book 1 | ✅ verified — 140 passed, 3 skipped |
...
- Starting Class 4, a way to actually call Gemini (`GOOGLE_API_KEY` or a Vertex AI project) is needed to run the live-model tests and see the agents reason for real — not required to build or gate-test any checkpoint.
