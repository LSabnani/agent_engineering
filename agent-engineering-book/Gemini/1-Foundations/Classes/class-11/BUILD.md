# Building Class 11 with Antigravity

Goal: wrap the Class 10 workflow, unchanged, in a bounded ADK loop that processes a queue of accounts unattended. `golden-solution/` in this folder is the reference. Build your own copy in `my-work/gemini-book-1/class-11/`, then diff.

## Prerequisites

- **`../SETUP.md` complete.**
- Your Class 10 checkpoint, passing `./scripts/check.sh`, including a passing release gate.
...
```
cd my-work/gemini-book-1/class-11
