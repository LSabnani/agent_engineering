# Class 11 Slides — Loop Engineering with ADK
...
**On slide:** Class 10's release gate passes. The workflow is good enough to ship — run once, on request.
...
**On slide:** Nothing about `run_workflow` changes today. The loop wraps it, unchanged, exactly as Class 10 left it.
