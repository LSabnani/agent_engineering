# PowerShell Helper Script to run the GCP Conference Website
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "   GCP Next-Gen Summit 2026 Launcher      " -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
Write-Host "The website will be active at: http://127.0.0.1:5001" -ForegroundColor Green
